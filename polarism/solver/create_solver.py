...
def create_solver(state, config, grid, potential, laser, reservoir, boundary_condition):
    ...
    return available_solvers[config.solver.method](state, config, grid, potential, laser, reservoir, boundary_condition)